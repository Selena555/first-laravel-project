                    ...
                    <div class="blog-single-post-thumb">
                        ...
                        <div class="blog-post-format">
                            ...
                            <span><a href="#"><i class="fa fa-comment-o"></i>
                                    {{ trans_choice(':count комментарий|:count комментария|:count комментариев', $post->comments->count())}}
                                </a></span>
                        </div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            >
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"><i class="fa fa-trash-o"></i>Удалить</button>
                                            </form>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="blog-comment-form">
                        @auth
                            ...
                            <form action="{{ route('comments.store') }}" method="post">
                                ...
                                <textarea name="message" rows="5" class="form-control tinyMce" id="message" placeholder="Message"
