...
{{--                                <span><a href="#"><img src="{{ asset('assets/images/author-image1.jpg') }}" class="img-responsive img-circle" alt="Картинка автора"> Jen Lopez</a></span>--}}
{{--                                <span><i class="fa fa-date"></i>{{$post->created_at->translatedFormat('d F, Y')}}</span>--}}
{{--                                <span><a href="#content"><i class="fa fa-comment-o"></i>{{ trans_choice(':count комментарий|:count комментария|:count комментариев', $post->comments->count())}}</a></span>--}}
{{--                            </div>--}}
